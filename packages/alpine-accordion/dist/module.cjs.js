...
var E = (i) => {
  ...
  const s = (_a = i.getAttribute("data-accordion-value")) != null ? _a : "", o = t.getAttribute("aria-expanded") === "true";
...
var O = (i, t, e) => {
  ...
  if (!n.includes(s))
    return null;
  const o = n.indexOf(s), a = t ? o - 1 : o + 1, c = (_a = n[a]) != null ? _a : t ? n[n.length - 1] : n[0], u = d(":scope > [data-accordion-trigger]", c);
