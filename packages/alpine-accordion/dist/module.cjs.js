...
var E = (n) => {
  ...
  const o = (_a = n.getAttribute("data-accordion-value")) != null ? _a : "", s = t.getAttribute("aria-expanded") === "true";
...
var L = (n, t, e) => {
  ...
  return (_a = l("[data-accordion-trigger]", o[a])) != null ? _a : t ? l("[data-accordion-trigger]", o[o.length - 1]) : l("[data-accordion-trigger]", o[0]);
};
var S = (n, t) => {
